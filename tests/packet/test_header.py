...
class HeaderTest(unittest.TestCase):
    ...
    def test_equal(self):
        header1 = ShadowsocksPacketHeader(port=80, addr_type=constants.ADDRTYPE_HOST, addr='www.google.com')
        header2 = ShadowsocksPacketHeader(port=80, addr_type=constants.ADDRTYPE_HOST, addr='www.google.com')
    ...
    def test_to_bytes_and_from_bytes(self):
        ...
        header2 = ShadowsocksPacketHeader(port=53, addr_type=constants.ADDRTYPE_IPV4, addr='8.8.8.8')
        ...
        header3 = ShadowsocksPacketHeader(port=80, addr_type=constants.ADDRTYPE_IPV6, addr='2404:6800:4005:805::1011')
