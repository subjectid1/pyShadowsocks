...
class HeaderTest(unittest.TestCase):
    ...
    def test_equal(self):
        header1 = ShadowsocksHeader(port=80, addr_type=constants.ADDRTYPE_HOST, addr='www.google.com')
        header2 = ShadowsocksHeader(port=80, addr_type=constants.ADDRTYPE_HOST, addr='www.google.com')
